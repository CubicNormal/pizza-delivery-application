...
class MainPanel extends JPanel implements ActionListener
{
    ...
    private File6_PanelTop panelTop;
    ...
    public MainPanel()
    {
        JLabel cap = new JLabel("Dominos Pizza");
        cap.setFont(new Font("verdana",1,30));
        cap.setOpaque(true);
        cap.setBackground(Color.RED);
        cap.setForeground(Color.YELLOW);
        cap.setBounds(10,10,760,50);
        cap.setHorizontalAlignment(JLabel.CENTER);
        Border br1=BorderFactory.createLineBorder(Color.GREEN,3);
        ...
        txtPhone=makeTextField(520,70,250,30);
        ...
        panelTop=new File6_PanelTop();
        panelTop.setLayout(new BorderLayout());
        panelTop.setBounds(350,120,420,150);
        add(panelTop);
        
        btnSubmit = makeButton("Submit",80,410,130,30);
        btnCommit = makeButton("Commit",260,410,130,30);
        btnShowMore = makeButton("Show>>",440,410,130,30);
        btnExit = makeButton("Exit",620,410,130,30);
